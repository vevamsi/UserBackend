...
public class UserController {
 ...
 public User updateUser(@PathVariable int userId, @RequestBody UserRegistrationDto apiDto) {
     User user = userService.findById(userId);
     ...
     user.setLast_name(apiDto.getLast_name());
     user.setEmail(apiDto.getEmail());
     user.setDepartmentCode(apiDto.getDepartmentCode());
     
         Address address = user.getAddress();
         address.setCity(apiDto.getCity());
         address.setState(apiDto.getState());
         address.setCountry(apiDto.getCountry());
         address.setPincode(apiDto.getPincode());
